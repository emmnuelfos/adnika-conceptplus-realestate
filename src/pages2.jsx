...
window.CONCEPTPLUS_EXTRA = {
  ...
  developers: [
    { name: 'Emaar Properties',  founded: 1997, delivered: 76, pipeline: 14, notable: 'Burj Khalifa · Downtown Dubai · Dubai Hills', img: 'assets/properties/02-downtown-penthouse-terrace.webp' },
    { name: 'Sobha Realty',      founded: 1976, delivered: 41, pipeline: 9,  notable: 'Sobha Hartland · Cassia Residences',         img: 'assets/properties/09-offplan-tower-show-apartment.webp' },
    { name: 'DAMAC Properties',  founded: 2002, delivered: 52, pipeline: 12, notable: 'AYKON City · DAMAC Hills · Akoya',          img: 'assets/properties/09-offplan-tower-skybridge.webp' },
    { name: 'Aldar Properties',  founded: 2004, delivered: 38, pipeline: 7,  notable: 'Saadiyat Island · Yas Island · Al Reem',     img: 'assets/properties/09-offplan-tower-lobby.webp' },
    { name: 'Meraas',            founded: 2007, delivered: 22, pipeline: 6,  notable: 'Bluewaters · City Walk · La Mer',            img: 'assets/properties/03-bluewaters-apt-balcony.webp' },
    { name: 'Nakheel',           founded: 2000, delivered: 31, pipeline: 8,  notable: 'Palm Jumeirah · The World · Deira Islands',  img: 'assets/properties/01-frond-m-villa-exterior.webp' },
    { name: 'Omniyat',           founded: 2005, delivered: 18, pipeline: 5,  notable: 'One at Palm · The Opus · Anwa',              img: 'assets/properties/09-offplan-tower-exterior.webp' },
    { name: 'Select Group',      founded: 2002, delivered: 14, pipeline: 4,  notable: 'Marina Gate · Six Senses Residences',        img: 'assets/properties/05-marina-duplex-terrace.webp' },
  ],
  careers: [
