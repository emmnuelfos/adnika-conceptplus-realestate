...
window.CONCEPTPLUS_DATA = (function () {
  ...
  // Real Dubai community centroids — used by the Leaflet map.
  const listings = [
    { id: 'L-2401', title: 'Garden-fronted villa, Frond M', community: 'Palm Jumeirah', subCommunity: 'Signature Villas', price: 42500000, type: 'Villa', furnishing: 'Furnished', beds: 6, baths: 7, sqft: 8200, photoCount: 32, dld: true, images: [U('photo-1613490493576-7fde63acd811'), U('photo-1600585154340-be6161a56a0c'), U('photo-1600566753190-17f0baa2a6c3'), U('photo-1600210491892-03d54c0aaf87')], agent: 0, sale: true, lat: 25.1124, lng: 55.1390 },
    { id: 'L-2402', title: 'Burj-view penthouse',           community: 'Downtown Dubai', subCommunity: 'Opera District', price: 18900000, type: 'Penthouse', furnishing: 'Unfurnished', beds: 4, baths: 5, sqft: 4760, photoCount: 24, dld: true, images: [U('photo-1582268611958-ebfd161ef9cf'), U('photo-1560448204-e02f11c3d0e2'), U('photo-1567496898669-ee935f5f647a')], agent: 4, sale: true, lat: 25.1972, lng: 55.2744 },
    { id: 'L-2403', title: 'Sea-line apartment, Bluewaters',community: 'Dubai Marina',   subCommunity: 'Bluewaters Residences', price: 6850000, type: 'Apartment', furnishing: 'Semi-furnished', beds: 3, baths: 4, sqft: 2410, photoCount: 18, dld: true, images: [U('photo-1502672260266-1c1ef2d93688'), U('photo-1505691938895-1758d7feb511')], agent: 2, sale: true, lat: 25.0805, lng: 55.1403 },
    { id: 'L-2404', title: 'Lakeside mansion',              community: 'Emirates Hills', subCommunity: 'Sector E',       price: 78000000, type: 'Villa', furnishing: 'Furnished', beds: 8, baths: 10, sqft: 16800, photoCount: 41, dld: true, images: [U('photo-1600596542815-ffad4c1539a9'), U('photo-1613977257363-707ba9348227')], agent: 3, sale: true, lat: 25.0648, lng: 55.1797 },
    { id: 'L-2405', title: 'Marina-view duplex',            community: 'Dubai Marina',   subCommunity: 'Cayan Tower',    price: 9450000, type: 'Penthouse', furnishing: 'Furnished', beds: 4, baths: 5, sqft: 3680, photoCount: 22, dld: true, images: [U('photo-1519085360753-af0119f7cbe7')], agent: 2, sale: true, lat: 25.0860, lng: 55.1480 },
    { id: 'L-2406', title: 'Skyline corner, Executive Bay', community: 'Business Bay',   subCommunity: 'Executive Towers', price: 3200000, type: 'Apartment', furnishing: 'Furnished', beds: 2, baths: 3, sqft: 1640, photoCount: 16, dld: false, images: [U('photo-1472099645785-5658abf4ff4e')], agent: 5, sale: true, lat: 25.1872, lng: 55.2655 },
    { id: 'L-2407', title: 'Atrium villa, Jumeirah Bay',    community: 'Jumeirah Bay',   subCommunity: 'Bulgari Resort', price: 35400000, type: 'Villa', furnishing: 'Unfurnished', beds: 5, baths: 6, sqft: 7100, photoCount: 28, dld: true, images: [U('photo-1507003211169-0a1dd7228f2d'), U('photo-1600566753086-00f18fb6b3ea')], agent: 0, sale: true, lat: 25.2200, lng: 55.2426 },
    { id: 'L-2408', title: 'Garden townhouse',              community: 'Jumeirah Village', subCommunity: 'District 12',  price: 1980000, type: 'Townhouse', furnishing: 'Unfurnished', beds: 3, baths: 4, sqft: 2240, photoCount: 14, dld: true, images: [U('photo-1523217582562-09d0def993a6')], agent: 1, sale: true, lat: 25.0577, lng: 55.2135 },
  ];
